...
interface SavingsProgressScreenProps {
  onContinue: () => void
  onBack: () => void
  currentProgress: number // Progress percentage (e.g., 95)
}

/**
 * Savings & progress screen – shown before the last question
 * Shows potential savings and progress through the questionnaire
 */
        ...
        <div className="w-full max-w-md lg:max-w-lg text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-2xl lg:text-3xl font-bold font-display text-dermai-neutral-900 leading-tight">
              Optimize your cosmetic spending with precise personalization
            </h1>
            
            <p className="text-dermai-neutral-600 text-lg leading-relaxed">
              Our AI selects only the products your skin genuinely needs, avoiding unnecessary purchases and mismatched routines.
            </p>
          </div>
          ...
          <div className="bg-dermai-pure/60 backdrop-blur-sm border border-dermai-nude-200 rounded-2xl p-6 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-dermai-neutral-700 font-medium">Accurate, tailored selection</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-dermai-neutral-700 font-medium">Average savings of 56%</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-dermai-neutral-700 font-medium">Guaranteed optimized results</span>
            </div>
          </div>
        </div>
      </div>
