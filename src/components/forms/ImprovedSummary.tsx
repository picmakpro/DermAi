        ...
        <div className="bg-dermai-nude-50 rounded-xl p-4">
          ...
          {isLoadingPhotos ? (
            ...
            <p className="text-sm text-dermai-neutral-600 ml-9">
              {photosCount} face photo{photosCount > 1 ? 's' : ''} uploaded
            </p>
          )}
        </div>
        ...
        {selectedAgeRange && (
          <div className="bg-dermai-nude-50 rounded-xl p-4">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-dermai-neutral-800">Personal profile</span>
            </div>
        ...
        {data.skinConcerns.primary.length > 0 && (
          <div className="bg-dermai-nude-50 rounded-xl p-4">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-dermai-neutral-800">Skin concerns</span>
            </div>
        ...
        {hasRoutineProducts() && (
          <div className="bg-dermai-nude-50 rounded-xl p-4">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-dermai-neutral-800">Current skincare routine</span>
            </div>
            <div className="text-sm text-dermai-neutral-600 ml-9">
              <p><span className="font-medium text-dermai-neutral-700">Products used:</span></p>
        ...
        {(data.currentRoutine.routinePreference || data.currentRoutine.monthlyBudget) && (
          <div className="bg-dermai-nude-50 rounded-xl p-4">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-dermai-neutral-800">Personal preferences</span>
            </div>
            <div className="text-sm text-dermai-neutral-600 ml-9 space-y-1">
              {data.currentRoutine.routinePreference && (
                <p><span className="font-medium text-dermai-neutral-700">Desired routine type:</span> {data.currentRoutine.routinePreference}</p>
              )}
              <p><span className="font-medium text-dermai-neutral-700">Monthly budget:</span> {data.currentRoutine.monthlyBudget}</p>
            </div>
          </div>
        )}
        ...
        {data.allergies.ingredients.length > 0 && (
          <div className="bg-red-50 rounded-xl p-4 border border-red-200">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-red-800">Allergies & sensitivities</span>
            </div>
        ...
        {data.allergies.pastReactions.trim() && (
          <div className="bg-yellow-50 rounded-xl p-4 border border-yellow-200">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-yellow-800">Reaction history</span>
            </div>
            <div className="text-sm text-yellow-700 ml-9">
              <p><span className="font-medium text-yellow-800">Past reactions:</span></p>
        ...
        {isFormComplete() ? (
          <div className="bg-green-50 rounded-lg p-3 border border-green-200">
            <div className="flex items-center text-sm text-green-700">
              ...
              <span className="font-medium">Profile complete – ready for analysis!</span>
            </div>
          </div>
        ) : (
          <div className="bg-orange-50 rounded-lg p-3 border border-orange-200">
            <div className="flex items-center text-sm text-orange-700">
              ...
              <span className="font-medium">Some information is missing</span>
            </div>
          </div>
        )}
      </div>
